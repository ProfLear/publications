...
def _():
    ...
    profilometry_file  = "/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/MiniPlateSmallPre.txt"
...
def _(downsampled_scales, downsampled_zs, gaussian_filter, sf):
    ...
    downsampled_form = gaussian_filter(downsampled_zs, sigma=50)  #50 the form is on a size of 50 pixels in the downsampled data.
...
def _(
    ...
    prep_xyz_for_blender(downsampled_raw_zs_minus_form, r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/smallPreBlender.csv")
    return
...
def _(downsampled_raw_zs_minus_form, np, sf):
    custom_scale = [
        [0, 'rgb(102, 70, 17)'],     # Start (Min)
        [0.5, 'rgb(231, 159, 40)'], # Middle
        [1, 'rgb(255, 221, 166)']      # End (Max)
    ]

    downsampled_wave_map = sf.make_profile_image(downsampled_raw_zs_minus_form, 99.9, colorscale=custom_scale)
    downsampled_wave_map.update_layout(template = "simple_white", paper_bgcolor = 'rgba(0,0,0,0)')
    downsampled_wave_map.show()
    downsampled_wave_map.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/smallPreOrtho.png")
...
def _(downsampled_wave_map, go, sf):
    ...
    paired_heights = [
        [[211, 508, -59.18966e-6], [186, 528, 22.11384e-6]],
        [[436, 361, -47.08054e-6], [413, 375, 18.15918e-6]],
        [[203, 57, -53.38674e-6],  [174, 74 , 19.06186e-6]],
        [[640, 384, -50.61561e-6], [610, 404, 18.28498e-6]],
        [[116, 317, -38.04497e-6], [91, 332, 17.86708e-6]],
    ]

    mapped_heights = sf.map_paired_heights(go.Figure(downsampled_wave_map), paired_heights, low_color = "rgb(102, 70, 17)", high_color = "rgb(255, 221, 166)", line_color = "rgb(122, 122, 122)")
    mapped_heights.show()
    mapped_heights.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/smallPreMapped.png")
    return
