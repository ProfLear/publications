...
def _():
    ...
    profilometry_file  = "/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/SmallPatternTopBarnacle.txt"
...
def _(profilometry_file, sf):
    ...
    downsampled_zs, downsampled_scales = sf.import_and_downsample(profilometry_file, sampling = 11)
...
def _(downsampled_scales, downsampled_zs, gaussian_filter, sf):
    ...
    downsampled_form = gaussian_filter(downsampled_zs, sigma=200)  #50 the form is on a size of 50 pixels in the downsampled data.
...
def _(
    ...
    prep_xyz_for_blender(downsampled_raw_zs_minus_form, r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/smallPostBlender.csv")
    return
...
def _(downsampled_raw_zs_minus_form, np, sf):
    ...
    downsampled_wave_map.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/smallBarnacle.png")
...
def _(downsampled_wave_map, go, sf):
    ...
    paired_heights = [
        [[512, 300, -108.1236e-6], [489, 273, 52.5389e-6]],
        [[157, 635, -79.84602e-6], [136, 637, 58.48814e-6]],
        [[703, 625, -95.14444e-6],  [685, 618 , 56.25844e-6]],
        [[317, 144, -122.8402e-6], [295, 145, 49.13105e-6]],
        [[685, 138, -133.7959e-6], [667, 129, 53.79801e-6]],
    ]
    ...
    mapped_heights.show()
    mapped_heights.write_image(r"C:\Users\benle\OneDrive - The Pennsylvania State University\publications\JackieSharkSkin\forFigures\smallPostMapped.png")
    return
