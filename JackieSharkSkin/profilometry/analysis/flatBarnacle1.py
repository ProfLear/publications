...
def _():
    ...
    profilometry_file  = "../BigPatternTopBarnacle.txt"
...
def _(
    ...
    prep_xyz_for_blender(downsampled_raw_zs_minus_form, r"C:\Users\benle\OneDrive - The Pennsylvania State University\publications\JackieSharkSkin\forFigures\largePost.csv")
    return
...
def _(downsampled_raw_zs_minus_form, np, sf):
    ...
    downsampled_wave_map.write_image(r"C:\Users\benle\OneDrive - The Pennsylvania State University\publications\JackieSharkSkin\forFigures\smallPostOrtho.png")
