...
def _():
    ...
    profilometry_file  = "/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/BigPatternPost.txt"
...
def _(downsampled_scales, downsampled_zs, gaussian_filter, sf):
    ...
    downsampled_form = gaussian_filter(downsampled_zs, sigma=160)  #50 the form is on a size of 50 pixels in the downsampled data.
...
def _(
    ...
    prep_xyz_for_blender(downsampled_raw_zs_minus_form, r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/largePostBlender.csv")
    return
...
def _(downsampled_raw_zs_minus_form, np, sf):
    custom_scale = [
        [0, 'rgb(56, 18, 35)'],     # Start (Min)
        [0.5, 'rgb(162, 55, 104)'], # Middle
        [1, 'rgb(255, 128, 184)']      # End (Max)
    ]
    ...
    downsampled_wave_map.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/largePostOrtho.png")
...
def _(downsampled_wave_map, go, sf):
    ...
    mapped_heights.show()
    mapped_heights.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/largePostMapped.png")
    return
