...
def _():
    ...
    profilometry_file  = "/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/BlankPost.txt"
...
def _(downsampled_scales, downsampled_zs, gaussian_filter, sf):
    ...
    downsampled_form = gaussian_filter(downsampled_zs, sigma=60)  #50 the form is on a size of 50 pixels in the downsampled data.
...
def _(
    ...
    prep_xyz_for_blender(downsampled_raw_zs_minus_form, r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/flatPost.csv")
    return
...
def _(downsampled_raw_zs_minus_form, np, sf):
    ...
    downsampled_wave_map.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/flatPost.png")
