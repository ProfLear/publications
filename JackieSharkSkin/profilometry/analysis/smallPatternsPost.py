...
def _():
    ...
    profilometry_file  = "/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/SmallPatternPost.txt"
...
def _(downsampled_scales, downsampled_zs, gaussian_filter, sf):
    ...
    downsampled_form = gaussian_filter(downsampled_zs, sigma=80)  #50 the form is on a size of 50 pixels in the downsampled data.
...
def _(downsampled_raw_zs_minus_form, np, sf):
    ...
    downsampled_wave_map.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/smallPostOrtho.png")
...
def _(downsampled_wave_map, go, sf):
    ...
    mapped_heights.show()
    mapped_heights.write_image(r"/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/JackieSharkSkin/profilometry/smallPostMapped.png")
    return
