...
def _(R_np, bulk_toluene_density, mf, np, qp, reload):
    ...
    hd_toluene_distances = np.genfromtxt("/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/KristenPulse/MDSimulationResults/toluene_distances_low_density.csv",
                                       delimiter = ",")
    ...
    hd_dodecanethiol_distances = np.genfromtxt("/Users/benjaminlear/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/publicationsData/KristenPulse/MDSimulationResults/dodecanol_distances_low_density.csv",
                                       delimiter = ",")
